...
clf_names.append("Ridge Classifier")
clf_names.append("Perceptron")
clf_names.append("Passive-Aggressive")
clf_names.append("kNN")
clf_names.append("Liblinear model L2 penalty")
clf_names.append("SGD model L2 penalty")
clf_names.append("Liblinear model L1 penalty")
clf_names.append("SGD model L1 penalty")
clf_names.append("Elastic-Net penalty")
...
while i is not 0:
    try:
        print(clf_names2[i])
        print(models2[i].predict(count_vect.transform(["I want to kill you"])))
        print(models2[i].predict_proba(count_vect.transform(["I want to kill you"])))
        i=i-1
    except:
        i=i-1
